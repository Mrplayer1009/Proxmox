...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($titre) || empty($description)) {
        ...
        if (isset($result['success']) && $result['success']) {
            ...
            $error = 'Une erreur est survenue lors de l\'ajout de l\'annonce.';
        }
    }
}
?>
...
<head>
    ...
    <title>Ajouter une annonce - EcoDeli</title>
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold mb-6">Ajouter une annonce</h1>
        ...
        <?php if ($success): ?>
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4">
                <?= $success ?>
                <p class="mt-2">
                    <a href="annonces.php" class="underline">Retour à la liste des annonces</a>
                </p>
            </div>
        <?php endif; ?>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form method="post">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="annonces.php" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                        Annuler
                    </a>
                </div>
            </form>
