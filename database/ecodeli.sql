...
--
-- Hôte : localhost:3306
-- Généré le : mar. 15 juil. 2025 à 20:24
...
(15, 3, 'Vaisselle', 1, 0, '3.50', 1, 'Colis fragile contenant de la vaisselle', '25.00', 'en_cours', '2025-07-05', 'fragile', '2025-06-27 07:06:27', '2025-06-27 07:06:27'),
...
(19, 3, 'Café', 1, 3, '3.00', 0, 'Du café', '5.00', 'en_cours', NULL, 'Alimentaire', NULL, NULL);
...
(1, 1, '2025-07-01', '2025-11-09', 'actif', NULL, '2025-07-09 14:52:38', '2025-07-09 14:52:38');
...
(1, 3, 'pieces_prestataire/Pd7rqeBF8qphR4qw2qDYr94KmwHVB3h4fMMdhd78.pdf', 'Ecodeli', '1009001', '15 allée des platanes', '0770256895', 'validé', '2025-06-29 14:17:52', '2025-07-09 09:00:58'),
...
(1, 'T-shirt en coton bio', 'T-shirt unisexe 100% coton biologique, taille M', '19.99', 44, 0, 'https://example.com/images/tshirt.jpg', '2025-06-27 09:10:39', '2025-07-15 16:46:20', 1),
...
INSERT INTO `reservations` (`id_reservation`, `id_prestation`, `id_client`, `date`, `heure_debut`, `heure_fin`, `statut`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '2025-07-05', '09:00:00', '11:00:00', 'annulée', '2025-07-01 10:00:00', '2025-07-04 06:25:21'),
(2, 2, 2, '2025-07-10', '14:00:00', '16:00:00', 'en_attente', '2025-07-02 14:00:00', '2025-07-02 14:00:00'),
(3, 3, 4, '2025-07-15', '08:30:00', '10:30:00', 'refusée', '2025-07-03 09:00:00', '2025-07-03 09:00:00');
...
('IbOIZLUy9i2mxroPZo73NKdEnSZVpK0xwfnA1XbS', 3, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36 OPR/119.0.0.0', '', 1752598712);
...
ALTER TABLE `reservations`
  ...
  ADD KEY `reservations_id_prestation_foreign` (`id_prestation`),
...
--
ALTER TABLE `annonce`
  MODIFY `id_annonce` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `contrats`
  MODIFY `id_contrat` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `livraison`
  MODIFY `id_livraison` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `localisations`
  MODIFY `id_localisation` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `paiement`
  MODIFY `id_paiement` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `produits`
  MODIFY `id_produits` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT pour la table `reservations`
--
ALTER TABLE `reservations`
  MODIFY `id_reservation` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `utilisateur`
--
ALTER TABLE `utilisateur`
  MODIFY `id_utilisateur` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
ALTER TABLE `reservations`
  ...
  ADD CONSTRAINT `reservations_id_prestation_foreign` FOREIGN KEY (`id_prestation`) REFERENCES `prestations` (`id_prestation`) ON DELETE CASCADE;
COMMIT;
