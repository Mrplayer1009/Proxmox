...
<body class="bg-gray-50">
    ...
    <a href="prestataire.php" class="flex items-center space-x-2 text-gray-600 hover:text-blue-600">
        <span class="text-sm">Prestataire</span>
    </a>
    <a href="agenda.php" class="flex items-center space-x-2 text-gray-600 hover:text-blue-600">
