    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        @foreach($commercants as $commercant)
            <div class="border rounded-lg p-4 bg-white">
                ...
                <a href="{{ route('commerces.produits', $commercant->id_commercant) }}" class="mt-2 inline-block bg-orange-500 text-blue px-4 py-2 rounded hover:bg-orange-600 transition">Voir commerce</a>
            </div>
        @endforeach
    </div>
</div>
